...
xv_boost_lib_path=T:/Vivado/Vivado/2019.1/tps/boost_1_64_0
xvlog_opts="--relax -L axi_vip_v1_1_5 -L processing_system7_vip_v1_0_7 -L xilinx_vip"
xvhdl_opts="--relax"
...
{
  file="xsim.ini"
  lib_map_path="T:/Vivado/Vivado/2019.1/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
